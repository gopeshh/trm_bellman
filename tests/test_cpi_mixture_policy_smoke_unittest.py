"""
Tests for CPI mixture policy - unittest version.
...
class TestCPIMixturePolicy(unittest.TestCase):
    """Tests for CPI mixture policy mechanics."""

    def test_cpi_mixture_policy_runs(self):
        """Test that CPI mixture policy runs without errors."""
        ...
        probs = dist.probs
        self.assertEqual(probs.shape[-1], model_cfg["rl_num_actions"])
