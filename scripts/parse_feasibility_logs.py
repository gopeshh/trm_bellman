...
def main():
    ...
    algo_dirs = ["upi_trm", "ppo", "a2c", "dqn", "ablation_no_conservative", "ablation_no_contraction", "ablation_persistent_z", "ablation_persistent_z_no_contraction", "no_contraction", "persistent_z_no_contraction", "dqn_fixed"]
    seeds = [42, 123, 456]
