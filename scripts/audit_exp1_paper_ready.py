...
def update_provenance():
    """Preserve the generator-authored provenance file."""
    print("\n=== Updating PROVENANCE.md ===")
    provenance_path = OUT_DIR / "PROVENANCE.md"
    if provenance_path.exists():
        print(f"  Preserved {provenance_path}")
    else:
        print(f"  Missing {provenance_path}; run make_paper_figures_exp1_final.py first")
